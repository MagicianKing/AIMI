...
public class EdittextMoneyFilter implements InputFilter {
    //输入最大金额
    ...
    public CharSequence filter(CharSequence source, int start, int end,
        ...
        //已经输入小数点的情况下，只能输入数字  
        double sumMoney = Double.parseDouble(destText + sourceText);
        if (sumMoney > MAX_VALUE) {
            return dest.subSequence(dstart, dend);
        }
