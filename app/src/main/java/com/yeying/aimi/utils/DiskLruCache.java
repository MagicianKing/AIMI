...
import com.yeying.aimi.BuildConfig;
...
public class DiskLruCache {
    ...
    public static DiskLruCache openCache(Context context, File cacheDir, long maxByteSize) {
        ...
        if (cacheDir.isDirectory() && cacheDir.canWrite() && Util.getUsableSpace(cacheDir) > maxByteSize) {
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        final String cachePath = Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED || !Util.isExternalStorageRemovable() ? Util
    ...
    private boolean writeBitmapToFile(Bitmap bitmap, String file) throws IOException, FileNotFoundException {
        ...
        try {
            out = new BufferedOutputStream(new FileOutputStream(file), Util.IO_BUFFER_SIZE);
