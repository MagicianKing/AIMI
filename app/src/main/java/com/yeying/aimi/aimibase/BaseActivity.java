...
public class BaseActivity extends SwipeBackActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSwipeBackLayout.setSensitivity(this , 1);
    ...
    public void checkLocationPermission(final boolean isLocationCheck) {
        ...
        //请求定位权限
        this.requestPermissions(new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, "我们需要获取您的位置已提供更好的服务", new BaseActivity.PermissionCheckedLister() {
            @Override
