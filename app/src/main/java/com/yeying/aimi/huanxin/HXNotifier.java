...
public class HXNotifier {
    ...
    public static HXNotifier instance = null;
    protected static int notifyID = 0525; // start notification id
    protected static int foregroundNotifyID = 0555;
    public Ringtone ringtone = null;
    protected NotificationManager notificationManager = null;
    public static HashSet<String> fromUsers = new HashSet<String>();
    ...
    protected void sendNotification(List<EMMessage> messages, boolean isForeground) {
        for (EMMessage message : messages) {
            if (!isForeground) {
                ...
                if (message.getChatType() == ChatType.GroupChat || message.getChatType() == ChatType.Chat && !transCode.equals("send10150") && !transCode.equals("send10231") && !transCode.equals("12201")) {
                    notificationNum++;
    ...
    protected void sendNotification(EMMessage message, boolean isForeground, boolean numIncrease) {
        ...
        try {
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity(appContext, notifyID, msgIntent, PendingIntent.FLAG_ONE_SHOT);
        ...
        try {
            ...
            if (HXPreferenceUtils.getInstance().getSettingMsgSound()) {
                if (ringtone == null) {
                    ...
                    if (ringtone == null) {
                        Log.e(TAG, "cant find ringtone at:" + notificationUri.getPath());
                        return;
                    }
                }
