...
public class MineHomepage extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.other_attention:
                FollowAndFans.toFollowFans(MineHomepage.this,friendId,false);
                break;
            case R.id.other_fans:
                FollowAndFans.toFollowFans(MineHomepage.this,friendId,true);
                break;
            ...
            case R.id.other_foot:
                if (isSeefootmark == 1){
                    ...
                    if (isMine){//是自己的依然可以查看
                        ...
                        PromptUtils.showToast(MineHomepage.this,"对方不允许查看足迹");
                    }
                }
            ...
            case R.id.other_chat:
                SingleChat.toSingleChat(MineHomepage.this,mResp.userName,mResp.userId, API.CHATTYPE_SINGLE,AIMIApplication.dealHeadImg(mResp.headUrl));
                break;
            case R.id.other_back:
                finish();
                break;
            case R.id.other_money:
                WalletActivity.toWallet(MineHomepage.this);
                break;
            case R.id.other_head:
                //头像点击
                if (isMine){
                    startActivity(new Intent(MineHomepage.this, PersonActivity.class));
                }else {
                    OtherDetail.toOtherDetail(MineHomepage.this,mResp.userId);
                }
                break;
            ...
            case R.id.other_set:
                //用户设置
                startActivity(new Intent(MineHomepage.this, SetActivity.class));
                break;
        }
    }
    ...
    class MineDataTask extends DefaultTask {
        ...
        public void preExecute() {
            super.preExecute();
            pop = PromptUtils.getProgressDialogPop(MineHomepage.this);
        ...
        public void onError(DefaultError obj) {
            super.onError(obj);
            PromptUtils.showToast(MineHomepage.this,"网络错误");
        ...
        public void onOk(IProtocol protocol) {
            ...
            if (p10308.resp.transcode.equals("9999")){
                PromptUtils.showToast(MineHomepage.this,"系统异常");
            }else {
                mResp = p10308.resp;
                Glide.with(MineHomepage.this)
                        .load(AIMIApplication.dealHeadImg(p10308.resp.headUrl))
                        .transform(new CompressTransform(MineHomepage.this , p10308.resp.imgUrl+p10308.resp.headUrl))
                        .centerCrop()
                        .placeholder(R.drawable.default_icon)
                        .into(mHeadOther);
                mBlurTransformation = new BlurTransformation(MineHomepage.this , p10308.resp.imgUrl+p10308.resp.headUrl);
                Glide.with(MineHomepage.this)
                        .load(AIMIApplication.dealHeadImg(p10308.resp.headUrl))
                        .placeholder(R.drawable.default_icon)
    ...
    public class addNoteTask extends DefaultTask {
        ...
        public void preExecute() {
            super.preExecute();
            mPopupWindow = PromptUtils.getProgressDialogPop(MineHomepage.this);
        ...
        public void onOk(IProtocol protocol) {
            ...
            if (p10150.resp.transcode.equals("9999")) {
                PromptUtils.showToast(MineHomepage.this, p10150.resp.msg);
            } else {
    ...
    private void createPopWindow_guanzhu(){
        if (view_guanzhu==null){
            view_guanzhu= LayoutInflater.from(MineHomepage.this).inflate(R.layout.del_msg_window,null,false);
