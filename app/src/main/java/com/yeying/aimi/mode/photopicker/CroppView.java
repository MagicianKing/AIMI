...
public class CroppView extends View {
    ...
    public CroppView(Context context) {
        super(context);
    }

    public CroppView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CroppView(Context context, AttributeSet attrs, int defStyle) {
